...
<body>
    <div id="container-register">
        ...
        <form name="f1" method="POST" action="http://127.0.0.1/hotel-master/register.php">
            <div class="input">
...
<?php
	...
	$req0 = "select username from user where(username='$username');";
	$req0=mysql_query($req0);
	if (mysql_num_rows($req0)==0)
		{
			$sql="INSERT INTO user (username, email, password) VALUES ('$username', '$email', '$password');";
			$sql=mysql_query($sql);
		echo '<script>';
		echo "Swal.fire('Signed in', '', 'success')"; 
		echo "</script>";
		} 
	else{
		echo '<script>';
